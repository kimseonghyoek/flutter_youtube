...
import 'package:flutter_youtube/helper/login_background.dart';
    ...
    return Scaffold(
        body: Stack(
          ...
          children: <Widget>[
            ...
            CustomPaint(
              size: size,
              painter: LoginBackgrond(isJoin: Provider.of<JoinOrLogin>(context).isJoin),
            ),
            ...
            _logoImage(),
              ...
              Consumer<JoinOrLogin>(
                builder: (context, joinOrLogin, Widget child) =>GestureDetector(
                onTap: () {
                       joinOrLogin.toggle();
                },
                    child: Text(joinOrLogin.isJoin?"Already Have an Account? Sign in!":"Don't have any account? Create One!",
                     style: TextStyle(color: joinOrLogin.isJoin?Colors.red:Colors.indigo),)),
              ),
  ...
  Widget _logoImage() =>Expanded(
          child: Padding(
              ...
              child: FittedBox(
                  fit: BoxFit.contain,
                  child: CircleAvatar(
                  backgroundImage: NetworkImage("https://ifh.cc/g/x8j62.jpg"),
                ),
              ),
          ),
    );
                     ...
                     height: 50,
                      child: Consumer<JoinOrLogin>(
                        builder: (context, joinOrLogin, child) =>RaisedButton(
                          child: Text(
                            joinOrLogin.isJoin?"Join":"Login", style: TextStyle(fontSize: 20),),
